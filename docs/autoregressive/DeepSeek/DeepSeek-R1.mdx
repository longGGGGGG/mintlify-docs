...
import { DeepSeekR1BasicDeployment } from '/src/snippets/deepseek-r1-basic-deployment.jsx';
...
import { DeepSeekR1AdvancedDeployment } from '/src/snippets/deepseek-r1-advanced-deployment.jsx';

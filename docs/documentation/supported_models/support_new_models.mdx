...
metatags:
    description: "SGLang model development guide: add LLMs and MLLMs, port from vLLM, register external models, testing and benchmarking."
---
...
- **(Required) MMMU**: follow MMMU benchmark [README](https://github.com/sgl-project/sglang/blob/main/benchmark/mmmu/README) to get SGLang vs. HF Transformer accuracy comparison. The accuracy score from SGLang run should not be much lower than that from HF Transformer run. Similarly, follow https://docs.sglang.io/developer_guide/benchmark_and_profiling.html to get performance comparison: TTFT and throughput must meet or exceed baselines (e.g., HF Transformer).
...
## Documentation
Add to table of supported models in [generative_models](https://github.com/sgl-project/sglang/blob/main/docs/supported_models/generative_models) or [multimodal_language_models](https://github.com/sgl-project/sglang/blob/main/docs/supported_models/multimodal_language_models)

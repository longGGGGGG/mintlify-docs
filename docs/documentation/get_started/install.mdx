...
metatags:
  description: "Installation guide for SGLang on various platforms"
---

You can install SGLang using one of the methods below.
This page primarily applies to common NVIDIA GPU platforms.
For other or newer platforms, please refer to the dedicated pages for [AMD GPUs](../platforms/amd_gpu), [Intel Xeon CPUs](../platforms/cpu_server), [TPU](../platforms/tpu), [NVIDIA DGX Spark](https://lmsys.org/blog/2025-11-03-gpt-oss-on-nvidia-dgx-spark/), [NVIDIA Jetson](../platforms/nvidia_jetson), [Ascend NPUs](../platforms/ascend_npu), and [Intel XPU](../platforms/xpu).

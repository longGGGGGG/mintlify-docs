...
metatags:
    description: "SGLang Ascend NPU contribution guide: environment setup, pre-commit, unit tests, CI triggers, sgl-kernel-npu development."
---
...
Before contributing, please ensure that your environment is set up correctly. Follow the steps in the [Installation Guide](../platforms/ascend_npu) to install the necessary dependencies. we recommend [using docker](../platforms/ascend_npu.md#method-2-using-docker-image) to build the environment.

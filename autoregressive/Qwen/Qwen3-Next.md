...
**Deployment Commands**: Choose the appropriate deployment command based on your model variant and hardware platform.

<Tabs>
  <Tab title="Instruct (Non-Thinking)">
    **Qwen3-Next-80B-A3B-Instruct** - Standard instruction-following mode without explicit reasoning.
  ...
  <Tab title="Thinking">
    **Qwen3-Next-80B-A3B-Thinking** - Enables step-by-step reasoning with `--reasoning-parser qwen3`.
